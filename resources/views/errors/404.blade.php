    ...
    <div class="col-span-12 my-25">
        <div class="w-full flex items-center flex-wrap justify-center gap-10">
            <div class="grid gap-4 w-70">
                ...
                <div>
                    <h2 class="text-center text-black text-base font-semibold leading-relaxed pb-1">Uppss.. Halaman Tidak Ditemukan!</h2>
                    <p class="text-center text-black text-sm font-normal leading-snug pb-4">Sepertinya halaman yang Anda cari tidak ada, mungkin belum dibuat atau Anda salah alamat.</p>
                    <div class=" gap-3">
