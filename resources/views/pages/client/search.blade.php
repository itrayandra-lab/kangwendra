        ...
        <div class="container">
            <div class="page-content-wrap">
                <div class="page-content mx-auto text-center">
                    <h4>{{ $posts->count() }} posts found</h4>
                    <h2 class="justify-content-center">Search Result For: {{ request('qr') }}</h2>
                    <p>Hasil pencarian untuk kata kunci "{{ request('qr') }}" dari berbagai kategori artikel.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            @else
                <div class="no-posts-found text-center py-5">
                    ...
                    <p class="text-muted">Tidak ditemukan artikel untuk kata kunci "{{ request('qr') }}".</p>
