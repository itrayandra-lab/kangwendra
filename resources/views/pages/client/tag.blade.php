        ...
        <div class="container">
            <div class="page-content-wrap">
                <div class="page-content">
                    <h4>Tag</h4>
                    <h2>{{ $tag?->name ?? 'Tag' }} <span>{{ $posts->total() }} Posts</span></h2>
                    <p>Artikel dengan tag "{{ $tag?->name ?? 'Tag' }}" dari berbagai kategori menarik.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8">
                    ...
                    @else
                        <div class="no-posts-found text-center py-5">
                            ...
                            <p class="text-muted">Belum ada artikel dengan tag "{{ $tag?->name ?? 'Tag' }}".</p>
