        ...
        <div class="container">
            <div class="page-content-wrap">
                <div class="page-content">
                    <h4>Kategori</h4>
                    <h2>{{ $category->name }} <span>{{ $posts->total() }} Posts</span></h2>
                    <p>Artikel dalam kategori "{{ $category->name }}" dari berbagai topik menarik.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row gy-5 gy-lg-0 main-area">
                <div class="col-lg-8">
                                    ...
                                    <div class="post-card img-hover-move {{ !$item->image ? 'no-image' : '' }}">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <ul class="post-card-footer">
                                                <li><a href="/{{ $item->category?->slug ?? 'news' }}/{{ $item->slug }}" class="read-more">Baca Selengkapnya</a></li>
                                                <li>
                                                    <a href="#" class="views">
                        ...
                        @if($posts->hasPages())
                            <ul class="pagination-wrap justify-content-center">
                                ...
                                @else
                                    <li><span class="disabled">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="currentColor">
                                            <path d="m553.846-253.847-42.153-43.384 152.77-152.77H180.001v-59.998h484.462l-152.70-152.70 42.153-43.384L779.999-480 553.846-253.847Z"/>
                                        </svg>
                                    </span></li>
                                @endif
                            </ul>
                    ...
                    @else
                        <div class="no-posts-found text-center py-5">
                            ...
                            <p class="text-muted">Belum ada artikel yang tersedia untuk kategori ini.</p>
                ...
                <div class="col-lg-4">
                    <div class="main-sidebar">
                                ...
                                <div class="widget-content">
                                    <ul class="category-list">
                                        @foreach($allCategories as $cat)
                                            <li>
                                                <a href="/{{ $cat->slug }}" class="{{ $cat->id == $category->id ? 'active' : '' }}">
                                                    {{ $cat->name }}
                        ...
                        @php $tags = App\Models\PostTags::take(10)->get(); @endphp
                        @if($tags->count() > 0)
                            <div class="sidebar-widget">
                                <div class="widget-heading">
                                    <h3>Tag Populer</h3>
