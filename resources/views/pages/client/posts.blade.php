        ...
        <div class="container">
            <div class="page-content-wrap">
                <div class="page-content">
                    <h4>{{ $type ?? 'Berita' }}</h4>
                    <h2>{{ \Carbon\Carbon::now()->locale('en')->translatedFormat('F.d.Y') }} <span>{{ $posts->total() }} Posts</span></h2>
                    <p>Jelajahi koleksi artikel terbaru dan terpopuler dari berbagai kategori menarik.</p>
                </div>
            </div>
        </div>
    </section>
