                ...
                <div class="col-lg-8 offset-lg-2">
                    <header class="entry-header">
                        <ul class="post-meta">
                            ...
                            <li class="sep"></li>
                            <li><a href="#" class="date">{{ $page->created_at->format('d.m.Y') }}</a></li>
                        </ul>
                    ...
                    <footer class="entry-footer">
                        <ul class="post-social-share">
                            ...
                            <li class="twitter">
                                <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->fullUrl()) }}&text={{ urlencode($page->title) }}" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
                            ...
                            <li class="whatsapp">
                                <a href="https://wa.me/?text={{ urlencode($page->title . ' — ' . request()->fullUrl()) }}" target="_blank">
