<div class="col-span-12 my-5">
    <div class="w-full flex items-center flex-wrap justify-center gap-10">
        <div class="grid gap-4 w-60">
            ...
            <div>
                <h2 class="text-center text-black text-base font-semibold leading-relaxed pb-1">Uppss..
                    data tidak ada.</h2>
                <p class="text-center text-black text-sm font-normal leading-snug pb-4">Kemungkinan karna
                    data belum dibuat atau anda salah mencarinya</p>
